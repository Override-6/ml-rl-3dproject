...
use crate::player::{move_player, setup_player};
...
fn main() {
    ...
    App::new()
        ...
        .add_systems(Startup, (setup, setup_ui, setup_map, setup_player, spawn_arrow_assets))
        ...
        .insert_resource(RapierContextInitialization::InitializeDefaultRapierContext {
